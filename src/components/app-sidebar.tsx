...
const FINANCE: NavItem[] = [
  ...
  { title: "Charges", url: "/charges", icon: Receipt, roles: ["admin", "direction", "gestion_locative", "commercial", "technico_commercial", "technique", "juridique", "recouvrement"], allowUserIds: [CHRISTELLE_KOUASSI_ID] },
